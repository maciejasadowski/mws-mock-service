...
@XmlRootElement(name = "Rep_GetNavigList")
public class RepGetNavigList {
    ...
    @XmlElementRef(name = "path", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
