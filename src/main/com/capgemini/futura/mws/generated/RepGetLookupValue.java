 ...
 *         &lt;element name="lookupTableId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="lookupTableName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "Rep_GetLookupValue")
public class RepGetLookupValue {
    ...
    @XmlElementRef(name = "lookupTableId", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lookupTableId;
    @XmlElementRef(name = "lookupTableName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lookupTableName;
     ...
     *     
     */
    public JAXBElement<String> getLookupTableId() {
     ...
     *     
     */
    public void setLookupTableId(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getLookupTableName() {
     ...
     *     
     */
    public void setLookupTableName(JAXBElement<String> value) {
