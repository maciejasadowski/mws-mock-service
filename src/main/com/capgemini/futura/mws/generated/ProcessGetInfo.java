...
@XmlRootElement(name = "Process_GetInfo")
public class ProcessGetInfo {
    ...
    @XmlElementRef(name = "infoType", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> infoType;
     ...
     *     
     */
    public JAXBElement<String> getInfoType() {
        return infoType;
    }
     ...
     *     
     */
    public void setInfoType(JAXBElement<String> value) {
        this.infoType = value;
    }
