 ...
 *         &lt;element name="blobType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "Rep_UpdateItemBlob")
public class RepUpdateItemBlob {
    ...
    @XmlElementRef(name = "blobType", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> blobType;
     ...
     *     
     */
    public JAXBElement<String> getBlobType() {
        return blobType;
    }
     ...
     *     
     */
    public void setBlobType(JAXBElement<String> value) {
        this.blobType = value;
    }
