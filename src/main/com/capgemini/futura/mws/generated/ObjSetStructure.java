...
@XmlRootElement(name = "Obj_SetStructure")
public class ObjSetStructure {
    ...
    @XmlElementRef(name = "content", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
