...
@XmlRootElement(name = "Usr_GetUsersOfRole")
public class UsrGetUsersOfRole {
    ...
    @XmlElementRef(name = "roleName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
