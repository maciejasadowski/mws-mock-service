...
@XmlRootElement(name = "Process_SetData")
public class ProcessSetData {
    ...
    @XmlElementRef(name = "dataType", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
