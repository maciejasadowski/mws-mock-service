...
@XmlRootElement(name = "Rep_CreateVersion")
public class RepCreateVersion {
    ...
    @XmlElementRef(name = "versionType", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> versionType;
    @XmlElementRef(name = "versionLabel", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> versionLabel;
     ...
     *     
     */
    public JAXBElement<String> getVersionType() {
        return versionType;
    }
     ...
     *     
     */
    public void setVersionType(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getVersionLabel() {
        return versionLabel;
    }
     ...
     *     
     */
    public void setVersionLabel(JAXBElement<String> value) {
